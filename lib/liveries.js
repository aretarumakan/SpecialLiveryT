...
export const SPECIAL_LIVERIES = {
  ...
  'JA15XJ': { airline: 'JAL', type: 'A350-900', name: 'oneworld アライアンス塗装機', note: 'ワンワールド特別塗装機', color: '#1f4e9c' },
  ...
  // ANA（全日本空輸）
  'JA819A': { airline: 'ANA', type: 'B787-8', name: 'ピカチュウジェット NH', note: 'ポケモン特別塗装機', color: '#f4c20d' },
  'JA923A': { airline: 'ANA', type: 'B787-9', name: 'イーブイジェット NH', note: 'ポケモン特別塗装機', color: '#b5651d' },
  'JA58AN': { airline: 'ANA', type: 'B737-800', name: 'ANA ふるさと JET', note: '地域応援特別塗装機', color: '#1e5aa8' },
  // スカイマーク
